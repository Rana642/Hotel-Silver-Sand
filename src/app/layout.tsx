...
export const metadata: Metadata = {
  ...
  title: {
    default: "Hotel Silver Sand Multan | Hotel Near Multan Cantt Railway Station",
    template: "%s | Hotel Silver Sand Multan",
  },
  description:
    "Affordable hotel in Multan Cantt — a 500 m walk from Multan Cantt Railway Station and 2.4 km from Multan International Airport. Free WiFi, free private parking, 24-hour check-in and family rooms. Book direct on WhatsApp or by call and pay at the hotel.",
  keywords: [
