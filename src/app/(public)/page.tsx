...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hotel name / intro band — the photo stays clean, so what this place is,
          who it's for and why to trust it all live here instead. */}
      <section className="bg-cream">
        <div className="container-site py-12 text-center sm:py-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-slate">
            ...
            <span className="font-semibold text-navy">500 m walk</span> from Multan Cantt Railway
            Station. Book a hotel room in Multan direct, pay at the hotel, and cancel free if your
            plans change.
          </p>
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm text-slate">
            2.4 km from Multan International Airport • Free private parking • WiFi rated 10/10 on
            Booking.com • Breakfast included • Check in any hour, day or night
          </p>
